...
//			return "../jobKnowledge/box.jsp";
	...
	// 여행기 검색 ==================================================================================================================================================
		@RequestMapping("diary/search.do")
		public String diary_list_search(Model model, String page, HttpSession session, HttpServletRequest request, String search_keyword){
			try {
				if (page == null){
					page = "1";
				}
				...
				List<DiaryVO> list = dao.diaryList_search(map);			// DAO의 메소드 리턴값을 받는 List 변수
...
//				request.setAttribute("cList", cList);										// 쿠키값이 담긴 리스트를 전송
				...
				System.out.println("여행기 검색 컨트롤러");
				System.out.println(request.getRealPath(""));
			} catch (Exception e) {
				e.printStackTrace();
			}
