...
public class RManager_tour {
  public void graph(int no)
  {
	  try
	  {
		  ...
		  rc.voidEval("png(\"C:/springDev/springStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/3rdTeamProject/naver"+no+".png\")");
		  ...
		  rc.voidEval("wordcloud(names(data5),freq=data5,min.freq = 3,max.words = 100,random.order = F,scale = c(10,0.5),colors = rainbow(15))");
		  rc.voidEval("dev.off()");
		  rc.close();
