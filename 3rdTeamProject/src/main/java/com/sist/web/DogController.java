...
public class DogController {
	...
	public String dog_board_insert_ok(@ModelAttribute("vo") DogBoardVO vo, HttpSession session, HttpServletRequest request, MultipartFile file) {
		...
		System.out.println("id : " + id);
		vo.setId(id);
		String uploadPath = "C:/springDev/springStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/3rdTeamProject/";
	...
	// 게시판1 ajax
	@RequestMapping("dogboard/parkfind.do")
	public String parkfind(String no,Model model){
		...
		if(no!=null){
			...
			list=dao.dogLocationFind(gu[Integer.parseInt(no)]);
		}
		model.addAttribute("list", list);
