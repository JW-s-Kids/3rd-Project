        ...
        <td class="text-center">
          ...
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3">글쓰기</h2>
                <form method="post" action="update_ok.do?no=${vo.no }" class="p-5 bg-light" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="website">제목 *</label>
                    <input type="text" class="form-control" value=${vo.subject } name=subject>
                  </div>
                  <div class="form-group">
                    <label for="message">내용 *</label>
                    <textarea name=content cols="30" rows="10" class="form-control">${vo.content }</textarea>
                  </div>
                  <div class="form-group">
