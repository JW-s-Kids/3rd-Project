		          ...
		          <div class="col text-center">
		            <div class="block-27">
		              <ul>
		                ...
		                <li><a href="../dog/parksearch.do?page=${startPage-1 }&searchkey=${searchkey }#yong">&lt;</a></li>
		                </c:if>
		                <c:forEach var="i" begin="${startPage }" end="${endPage }">
		                 <c:if test="${i==curpage }">
		                 	<li class="active"><span><a href="../dog/parksearch.do?page=${i }&searchkey=${searchkey }#yong">${i }</a></span></li>
		                 </c:if>
		                 <c:if test="${i!=curpage }">
		                 	<li><a href="../dog/parksearch.do?page=${i }&searchkey=${searchkey }#yong">${i }</a></li>
		                 </c:if>
		                </c:forEach>
						<c:if test="${endPage<totalpage }">
		                <li><a href="../dog/parksearch.do?page=${endPage+1 }&searchkey=${searchkey }#yong">&gt;</a></li>
		                </c:if>
		              </ul>
		            </div>
		          </div>
