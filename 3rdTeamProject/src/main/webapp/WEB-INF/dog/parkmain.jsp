      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="../main/main.do">Home</a></span> <span><a href="../dog/parkmain.do">Park</a></span></p>
        	...
        	<div class="col-lg-3 sidebar ftco-animate">
        		<div class="sidebar-wrap bg-light ftco-animate">
        			...
        			<form action="../dog/parksearch.do#yong">
		              ...
		              <div class="form-group">
		                <input type="submit" id="Search" value="Search" class="btn btn-primary py-3 px-5">
		              </div>
		            </div>
	            </form>
        		</div>
          	 ...
          	 <c:forEach var="vo" items="${list }">
          		<div class="col-md-4 ftco-animate">
		    		...
		    		<%-- <a href="#" class="img img-2 d-flex justify-content-center align-items-center"><img src="${vo.img }" style="background-size:cover;"></a> --%>
		    					<a href="../dog/park_before.do?no=${vo.no }#yong" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${vo.img });">
		    			...
		    			<div class="text p-3">
		    					<div class="d-flex">
		    						<div class="one">
				    					<h3><a href="../dog/park_before.do?no=${vo.no }#yong">${vo.name }</a></h3>
				    					<p class="rate">
		    					...
		    					<p class="bottom-area d-flex">
		    						...
		    						<span class="ml-auto"><a href="../dog/park_before.do?no=${vo.no }#yong">상세보기</a></span>
		    					</p>
		    			</div>
		    		</div>
		    	</div>
		          ...
		          <div class="col text-center">
		            <div class="block-27">
		              <ul>
		                ...
		                <li><a href="../dog/parkmain.do?page=${startPage-1 }#yong">&lt;</a></li>
		                </c:if>
		                <c:forEach var="i" begin="${startPage }" end="${endPage }">
		                 <c:if test="${i==curpage }">
		                 	<li class="active"><span><a href="../dog/parkmain.do?page=${i }#yong">${i }</a></span></li>
		                 </c:if>
		                 <c:if test="${i!=curpage }">
		                 	<li><a href="../dog/parkmain.do?page=${i }#yong">${i }</a></li>
		                 </c:if>
		                </c:forEach>
						<c:if test="${endPage<totalpage }">
		                <li><a href="../dog/parkmain.do?page=${endPage+1 }#yong">&gt;</a></li>
		                </c:if>
		              </ul>
		            </div>
		          </div>
