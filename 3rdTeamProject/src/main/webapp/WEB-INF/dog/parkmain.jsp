        		...
        		<div class="sidebar-wrap bg-light ftco-animate">
        			...
        			<form action="#">
		              ...
		              <div class="form-group">
		                <input type="text" class="form-control" placeholder="공원명">
		              </div>
		              <div class="form-group">
	                    ...
	                    <select name="" id="" class="form-control" placeholder="Keyword search">
	                      ...
	                      <option value="">서울 동부</option>
	                      <option value="">서울 서부</option>
	                      <option value="">서울 남부</option>
	                      <option value="">서울 북부</option>
	                    </select>
	                  </div>
		              </div>
		              <div class="form-group">
		    		...
		    		<%-- <a href="#" class="img img-2 d-flex justify-content-center align-items-center"><img src="${vo.img }" style="background-size:cover;"></a> --%>
		    			...
		    			<div class="text p-3">
		    					...
		    					<p class="bottom-area d-flex">
		    						...
		    						<span class="ml-auto"><a href="#">상세보기</a></span>
		    					</p>
		    			</div>
		    		</div>
		    	</div>
